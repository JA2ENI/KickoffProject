...
public class MypageController {
    ...
    public ModelAndView myBoardList(@ModelAttribute("BoardDO")BoardDO boardDO, HttpSession session) throws Exception {
    	
        ModelAndView mv = new ModelAndView("/mypage/myBoard");

        List<BoardDO> myBoardList = mypageService.myBoardList((String)session.getAttribute("userId"));
