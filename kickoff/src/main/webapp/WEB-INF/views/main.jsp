...
<body>
	...
	<nav class="untree_co--site-mobile-menu">
		<div class="close-wrap d-flex">
			<a href="#" class="d-flex ml-auto js-menu-toggle"> <span
				class="close-label">Close</span>
				...
				<div class="site-nav-ul-wrap text-center d-none d-lg-block">
					<ul class="site-nav-ul js-clone-nav">
						...
						<li class="has-children"><a href="/helperList">용병</a>
							<ul class="dropdown">
								<li><a href="/helperList">모집 목록</a></li>
				...
				<div class="icons-wrap text-md-right">
					...
					<c:if test="${empty userId and empty empId}">
						<ul class="icons-top d-none d-lg-block">
							...
							<li><a href="#"
								onclick="alert('로그인 후 이용하실 수 있습니다.'); return false;"><span
									class="icon-person"></span></a></li>
						</ul>
					</c:if>
					...
					<c:if test="${empty userId and !empty empId}">
						<ul class="icons-top d-none d-lg-block">
							<li><a href="/logout"><span class="icon-lock"></span></a></li>
							<li><a href="/empReservation"><span class="icon-person"></span></a>
							</li>
						</ul>
					</c:if>

					<!-- Mobile Toggle -->
					<a href="#" class="d-block d-lg-none burger js-menu-toggle"
		...
		<div class="untree_co--site-main">
			...
			<div class="owl-carousel owl-hero">
				...
				<div class="untree_co--site-hero overlay"
					style="background-image: url('/main/images/main1.jpg')">
					<div class="container">
						<div class="row align-items-center justify-content-center">
							<div class="col-md-8">
								<div class="site-hero-contents text-center" data-aos="fade-up">
									...
									<div class="sub-text">
										<p class="text-white font-weight-bold">팀원을 찾고, 경기를 예약하고,
											즐거움을 더하다</p>
									</div>
								</div>
							</div>
				...
				<div class="untree_co--site-hero overlay"
					style="background-image: url('/main/images/main2.jpg')">
					<div class="container">
						<div class="row align-items-center justify-content-center">
							<div class="col-md-7">
								<div class="site-hero-contents text-center" data-aos="fade-up">
									<h1 class="hero-heading">Kick Off</h1>
									<div class="sub-text">
										<p class="text-white font-weight-bold">풋살을 즐기는 모든 이들을 위한
											Kick Off</p>
									</div>
								</div>
							</div>
				...
				<div class="untree_co--site-hero overlay"
					style="background-image: url('/main/images/main3.jpg')">
					<div class="container">
						<div class="row align-items-center justify-content-center">
							<div class="col-md-10">
								<div class="site-hero-contents text-center" data-aos="fade-up">
						...
						<div class="col-md-4">
							<div class="post-entry" data-aos="fade-up" data-aos-delay="100">
								...
								<div class="post-entry-contents">
									...
									<p>
										<a href="/reservation" class="readmore">Read more</a>
									</p>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="post-entry" data-aos="fade-up" data-aos-delay="100">
								...
								<div class="post-entry-contents">
									...
									<p>
										<a href="/game" class="readmore">Read more</a>
									</p>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="post-entry" data-aos="fade-up" data-aos-delay="200">
								...
								<div class="post-entry-contents">
									...
									<p>
										<a href="/board" class="readmore">Read more</a>
									</p>
								</div>
							</div>
						</div>
