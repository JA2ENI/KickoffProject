  ...
  <div class="form-container sign-up-container">
    <form method="POST" name="findUser" action="/findUserPw">
      ...
      <br />
	      ...
	      <input type="text" placeholder="핸드폰 번호" name="inputPhoneNumberPw" id="inputPhoneNumberPw" style="width:200px;" />
  ...
  <div class="form-container sign-in-container">
    <form method="POST" name="findUser" action="/findUserId">
      ...
      <br />
	      ...
	      <input type="text" placeholder="핸드폰 번호" name="inputPhoneNumber" id="inputPhoneNumber" style="width:200px;" />
