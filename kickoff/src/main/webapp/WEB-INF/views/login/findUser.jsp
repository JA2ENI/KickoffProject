	...
	<div class="container" id="container">
		<div class="form-container sign-up-container">
			<form method="POST" name="findUser" action="/findUserPw">
				<h1>비밀번호 찾기</h1>
				<h4>개인 회원용</h4>
				<br /> <input type="text" placeholder="아이디" name="userId"
					id="userId" /> <input type="text" placeholder="핸드폰 번호"
					name="inputPhoneNumberPw" id="inputPhoneNumberPw"
					style="width: 200px;" />
				<button type="button" id="sendPhoneNumberPw"
					name="sendPhoneNumberPw">전송</button>
				<input type="text" placeholder="인증 번호" id="inputCertifiedNumberPw"
					name="inputCertifiedNumberPw" style="width: 200px;" />
				<button type="button" id="confirmButtonPw" name="confirmButtonPw">인증</button>
				<button type="submit" id="findUserPw" name="findUserPw"
					onclick="findUser.submit();">비밀번호 찾기</button>
			...
			<form method="POST" name="findUser" action="/findUserId">
				<div class="row-container">
					...
					<div class="sendContainer">
						<input type="text" placeholder="핸드폰 번호" name="inputPhoneNumber"
							id="inputPhoneNumber"/>
						<button type="button" id="sendPhoneNumber" name="sendPhoneNumber">전송</button>
					</div>
					<div class="confirmContainer">
						<input type="text" placeholder="인증 번호" id="inputCertifiedNumber"
							name="inputCertifiedNumber" style="width: 200px;" />
						<button type="button" id="confirmButton" name="confirmButton">인증</button>
					</div>
					<button type="submit" id="findUserId" name="findUserId"
						onclick="findUser.submit();">아이디 찾기</button>
		            ...
		            $('#confirmButton').click(function(){
		                if($.trim(res) == $('#inputCertifiedNumber').val()){
		                    Swal.fire(
		                    	...
		                    	// 이름 입력과 휴대폰 인증이 완료되면 아이디 찾기 버튼 활성화
